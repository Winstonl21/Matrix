...
START_TEST(eq2) {
  ...
  m2.matrix[0][0] = 1.32479;
  m2.matrix[0][1] = 2.78788;
  m2.matrix[0][2] = 3234.123235;
  m2.matrix[1][0] = 17.345436;
  m2.matrix[1][1] = 1.435546;
  m2.matrix[1][2] = 1.878797;
  m2.matrix[2][0] = 145.344565;
...
START_TEST(eq3) {
  ...
  m2.matrix[2][1] = 5.455623; // вот здесь различается
  m2.matrix[2][2] = 4.234435;
